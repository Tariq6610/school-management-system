  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-canvas text-ink-900">
      <div className="max-w-xl w-full space-y-6 rounded-card bg-surface p-8 border border-rule shadow-overlay">
        {/* Dev-only notice */}
        <div className="rounded-control bg-amber-500/10 border border-amber-500/30 px-3 py-2 text-xs text-amber-800 flex items-center gap-2">
          <span aria-hidden>🛠️</span>
          <span>
            Internal developer page — component &amp; UI-kit showcase only. Not part of the product flow.{' '}
